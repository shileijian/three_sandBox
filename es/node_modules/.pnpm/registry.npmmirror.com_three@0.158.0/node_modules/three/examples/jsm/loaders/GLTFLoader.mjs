import { Loader as ge, LoaderUtils as q, FileLoader as ae, Color as C, LinearSRGBColorSpace as b, SpotLight as Te, PointLight as Re, DirectionalLight as Ee, MeshBasicMaterial as H, SRGBColorSpace as G, MeshPhysicalMaterial as I, Vector2 as ce, Matrix4 as B, Vector3 as F, Quaternion as ue, InstancedMesh as xe, InstancedBufferAttribute as _e, Object3D as le, TextureLoader as Le, ImageBitmapLoader as Se, BufferAttribute as U, InterleavedBuffer as ye, InterleavedBufferAttribute as Me, LinearFilter as fe, LinearMipmapLinearFilter as de, RepeatWrapping as W, PointsMaterial as we, Material as j, LineBasicMaterial as Ne, MeshStandardMaterial as he, DoubleSide as be, PropertyBinding as Ie, BufferGeometry as Oe, SkinnedMesh as Ce, Mesh as Fe, LineSegments as De, Line as Pe, LineLoop as ke, Points as He, Group as K, PerspectiveCamera as Ge, MathUtils as Be, OrthographicCamera as ve, Skeleton as Ue, AnimationClip as je, Bone as Ke, InterpolateLinear as pe, ColorManagement as Z, NearestFilter as Ve, NearestMipmapNearestFilter as Xe, LinearMipmapNearestFilter as ze, NearestMipmapLinearFilter as qe, ClampToEdgeWrapping as We, MirroredRepeatWrapping as Ye, InterpolateDiscrete as Qe, FrontSide as Ze, Texture as J, TriangleStripDrawMode as Je, TriangleFanDrawMode as $e, VectorKeyframeTrack as $, NumberKeyframeTrack as ee, QuaternionKeyframeTrack as te, Box3 as et, Sphere as tt, Interpolant as nt } from "../../../build/three.module.mjs";
import { toTrianglesDrawMode as ne } from "../utils/BufferGeometryUtils.mjs";
class Ht extends ge {
  constructor(t) {
  ...
  parse(t, e, r, n) {
    ...
    if (typeof t == "string")
      ...
      if (o.decode(new Uint8Array(t, 0, 4)) === me) {
        try {
          i[A.KHR_BINARY_GLTF] = new Et(t);
        } catch (u) {
          n && n(u);
          return;
        }
...
class rt {
  ...
  _loadLight(t) {
    ...
    o.color !== void 0 && l.setRGB(o.color[0], o.color[1], o.color[2], b);
    ...
    switch (o.type) {
      case "directional":
        ...
        break;
      case "point":
        c = new Re(l), c.distance = u;
        break;
      case "spot":
        c = new Te(l), c.distance = u, o.spot = o.spot || {}, o.spot.innerConeAngle = o.spot.innerConeAngle !== void 0 ? o.spot.innerConeAngle : 0, o.spot.outerConeAngle = o.spot.outerConeAngle !== void 0 ? o.spot.outerConeAngle : Math.PI / 4, c.angle = o.spot.outerConeAngle, c.penumbra = 1 - o.spot.innerConeAngle / o.spot.outerConeAngle, c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      default:
        throw new Error("THREE.GLTFLoader: Unexpected light type: " + o.type);
    }
    return c.position.set(0, 0, 0), c.decay = 2, N(c, o), o.intensity !== void 0 && (c.intensity = o.intensity), c.name = e.createUniqueName(o.name || "light_" + t), n = Promise.resolve(c), e.cache.add(r, n), n;
  }
  getDependency(t, e) {
    if (t === "light")
  ...
  extendParams(t, e, r) {
    ...
    if (s) {
      if (Array.isArray(s.baseColorFactor)) {
        ...
        t.color.setRGB(i[0], i[1], i[2], b), t.opacity = i[3];
      }
      s.baseColorTexture !== void 0 && n.push(r.assignTexture(t, "map", s.baseColorTexture, G));
    }
...
class at {
  ...
  getMaterialType(t) {
    ...
    return !r.extensions || !r.extensions[this.name] ? null : I;
  }
  extendMaterialParams(t, e) {
...
class ut {
  ...
  extendMaterialParams(t, e) {
    ...
    if (i.sheenColorFactor !== void 0) {
      ...
      e.sheenColor.setRGB(a[0], a[1], a[2], b);
    }
    return i.sheenRoughnessFactor !== void 0 && (e.sheenRoughness = i.sheenRoughnessFactor), i.sheenColorTexture !== void 0 && s.push(r.assignTexture(e, "sheenColorMap", i.sheenColorTexture, G)), i.sheenRoughnessTexture !== void 0 && s.push(r.assignTexture(e, "sheenRoughnessMap", i.sheenRoughnessTexture)), Promise.all(s);
  }
}
class lt {
  constructor(t) {
...
class ft {
  ...
  extendMaterialParams(t, e) {
    ...
    return e.attenuationColor = new C().setRGB(a[0], a[1], a[2], b), Promise.all(s);
  }
}
class dt {
  constructor(t) {
...
class ht {
  ...
  extendMaterialParams(t, e) {
    ...
    return e.specularColor = new C().setRGB(a[0], a[1], a[2], b), i.specularColorTexture !== void 0 && s.push(r.assignTexture(e, "specularColorMap", i.specularColorTexture, G)), Promise.all(s);
  }
}
class pt {
  constructor(t) {
...
class Rt {
  ...
  createNodeMesh(t) {
    ...
    return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(t)), Promise.all(a).then((c) => {
      ...
      for (const p of u) {
        const T = new B(), m = new F(), g = new ue(), E = new F(1, 1, 1), x = new xe(p.geometry, p.material, f);
        for (let R = 0; R < f; R++)
          o.TRANSLATION && m.fromBufferAttribute(o.TRANSLATION, R), o.ROTATION && g.fromBufferAttribute(o.ROTATION, R), o.SCALE && E.fromBufferAttribute(o.SCALE, R), x.setMatrixAt(R, T.compose(m, g, E));
        for (const R in o)
          if (R === "_COLOR_0") {
            const S = o[R];
            x.instanceColor = new _e(S.array, S.itemSize, S.normalized);
          } else
            R !== "TRANSLATION" && R !== "ROTATION" && R !== "SCALE" && p.geometry.setAttribute(R, o[R]);
        le.prototype.copy.call(x, p), this.parser.assignFinalMaterial(x), h.push(x);
      }
      return l.isGroup ? (l.clear(), l.add(...h), l) : h[0];
    }));
  }
}
const me = "glTF", k = 12, se = { JSON: 1313821514, BIN: 5130562 };
class Et {
  constructor(t) {
...
class xt {
  ...
  decodePrimitive(t, e) {
    ...
    for (const l in t.attributes) {
      const u = Y[l] || l.toLowerCase();
      if (i[l] !== void 0) {
        const f = r.accessors[t.attributes[l]], h = D[f.componentType];
      ...
      return new Promise(function(u) {
        n.decodeDracoFile(l, function(f) {
          for (const h in f.attributes) {
            const p = f.attributes[h], T = o[h];
            T !== void 0 && (p.normalized = T);
          }
          u(f);
        }, a, c);
      });
...
class Ae extends nt {
  ...
  interpolate_(t, e, r, n) {
    const s = this.resultBuffer, i = this.sampleValues, a = this.valueSize, o = a * 2, c = a * 3, l = n - e, u = (r - e) / l, f = u * u, h = f * u, p = t * c, T = p - c, m = -2 * h + 3 * f, g = h - f, E = 1 - m, x = g - f + u;
    for (let R = 0; R !== a; R++) {
      const S = i[T + R + a], y = i[T + R + o] * l, L = i[p + R + a], P = i[p + R] * l;
      s[R] = E * S + x * y + m * L + g * P;
    }
    return s;
  }
...
class yt extends Ae {
  interpolate_(t, e, r, n) {
    ...
    return St.fromArray(s).normalize().toArray(s), s;
  }
}
const _ = {
  FLOAT: 5126,
...
function wt(d) {
  return d.DefaultMaterial === void 0 && (d.DefaultMaterial = new he({
    color: 16777215,
    emissive: 0,
    metalness: 1,
    roughness: 1,
...
function It(d) {
  ...
  if (e ? t = "draco:" + e.bufferView + ":" + e.indices + ":" + z(e.attributes) : t = d.indices + ":" + z(d.attributes) + ":" + d.mode, d.targets !== void 0)
...
class Ft {
  constructor(t = {}, e = {}) {
    ...
    let r = !1, n = !1, s = -1;
    typeof navigator < "u" && (r = /^((?!chrome|android).)*safari/i.test(navigator.userAgent) === !0, n = navigator.userAgent.indexOf("Firefox") > -1, s = n ? navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1] : -1), typeof createImageBitmap > "u" || r || n && s < 98 ? this.textureLoader = new Le(this.options.manager) : this.textureLoader = new Se(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new ae(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
  }
  setExtensions(t) {
    this.extensions = t;
  }
  ...
  parse(t, e) {
    ...
    this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(i) {
      ...
      return O(s, a, n), N(a, n), Promise.all(r._invokeAll(function(o) {
  ...
  loadBuffer(t) {
    ...
    return new Promise(function(s, i) {
      r.load(q.resolveURL(e.uri, n.path), s, void 0, function() {
  ...
  loadAccessor(t) {
    ...
    if (n.bufferView === void 0 && n.sparse === void 0) {
      const i = V[n.type], a = D[n.componentType], o = n.normalized === !0, c = new a(n.count * i);
      return Promise.resolve(new U(c, i, o));
    }
    const s = [];
    return n.bufferView !== void 0 ? s.push(this.getDependency("bufferView", n.bufferView)) : s.push(null), n.sparse !== void 0 && (s.push(this.getDependency("bufferView", n.sparse.indices.bufferView)), s.push(this.getDependency("bufferView", n.sparse.values.bufferView))), Promise.all(s).then(function(i) {
      const a = i[0], o = V[n.type], c = D[n.componentType], l = c.BYTES_PER_ELEMENT, u = l * o, f = n.byteOffset || 0, h = n.bufferView !== void 0 ? r.bufferViews[n.bufferView].byteStride : void 0, p = n.normalized === !0;
      let T, m;
      if (h && h !== u) {
        const g = Math.floor(f / h), E = "InterleavedBuffer:" + n.bufferView + ":" + n.componentType + ":" + g + ":" + n.count;
        let x = e.cache.get(E);
        x || (T = new c(a, g * h, n.count * h / l), x = new ye(T, h / l), e.cache.add(E, x)), m = new Me(x, o, f % h / l, p);
      } else
        a === null ? T = new c(n.count * o) : T = new c(a, f, n.count * o), m = new U(T, o, p);
      if (n.sparse !== void 0) {
        const g = V.SCALAR, E = D[n.sparse.indices.componentType], x = n.sparse.indices.byteOffset || 0, R = n.sparse.values.byteOffset || 0, S = new E(i[1], x, n.sparse.count * g), y = new c(i[2], R, n.sparse.count * o);
        a !== null && (m = new U(m.array.slice(), m.itemSize, m.normalized));
        for (let L = 0, P = S.length; L < P; L++) {
          const M = S[L];
          if (m.setX(M, y[L * o]), o >= 2 && m.setY(M, y[L * o + 1]), o >= 3 && m.setZ(M, y[L * o + 2]), o >= 4 && m.setW(M, y[L * o + 3]), o >= 5)
  ...
  loadTextureImage(t, e, r) {
    ...
    const c = this.loadImageSource(e, r).then(function(l) {
      ...
      return l.magFilter = re[f.magFilter] || fe, l.minFilter = re[f.minFilter] || de, l.wrapS = ie[f.wrapS] || W, l.wrapT = ie[f.wrapT] || W, n.associations.set(l, { textures: t }), l;
    }).catch(function() {
      return null;
    });
    ...
    const l = Promise.resolve(o).then(function(u) {
      return new Promise(function(f, h) {
        ...
        e.isImageBitmapLoader === !0 && (p = function(T) {
          const m = new J(T);
          m.needsUpdate = !0, f(m);
        }), e.load(q.resolveURL(u, s.path), p, void 0, h);
      });
    }).then(function(u) {
      return c === !0 && a.revokeObjectURL(o), u.userData.mimeType = i.mimeType || Ot(i.uri), u;
    }).catch(function(u) {
  ...
  assignFinalMaterial(t) {
    ...
    if (t.isPoints) {
      ...
      o || (o = new we(), j.prototype.copy.call(o, r), o.color.copy(r.color), o.map = r.map, o.sizeAttenuation = !1, this.cache.add(a, o)), r = o;
    } else if (t.isLine) {
      const a = "LineBasicMaterial:" + r.uuid;
      let o = this.cache.get(a);
      o || (o = new Ne(), j.prototype.copy.call(o, r), o.color.copy(r.color), o.map = r.map, this.cache.add(a, o)), r = o;
    }
    if (n || s || i) {
  ...
  loadMaterial(t) {
    ...
    if (o[A.KHR_MATERIALS_UNLIT]) {
      ...
      if (a.color = new C(1, 1, 1), a.opacity = 1, Array.isArray(u.baseColorFactor)) {
        ...
        a.color.setRGB(f[0], f[1], f[2], b), a.opacity = f[3];
      }
      u.baseColorTexture !== void 0 && c.push(e.assignTexture(a, "map", u.baseColorTexture, G)), a.metalness = u.metallicFactor !== void 0 ? u.metallicFactor : 1, a.roughness = u.roughnessFactor !== void 0 ? u.roughnessFactor : 1, u.metallicRoughnessTexture !== void 0 && (c.push(e.assignTexture(a, "metalnessMap", u.metallicRoughnessTexture)), c.push(e.assignTexture(a, "roughnessMap", u.metallicRoughnessTexture))), i = this._invokeOne(function(f) {
    ...
    s.doubleSided === !0 && (a.side = be);
    const l = s.alphaMode || X.OPAQUE;
    if (l === X.BLEND ? (a.transparent = !0, a.depthWrite = !1) : (a.transparent = !1, l === X.MASK && (a.alphaTest = s.alphaCutoff !== void 0 ? s.alphaCutoff : 0.5)), s.normalTexture !== void 0 && i !== H && (c.push(e.assignTexture(a, "normalMap", s.normalTexture)), a.normalScale = new ce(1, 1), s.normalTexture.scale !== void 0)) {
    ...
    if (s.occlusionTexture !== void 0 && i !== H && (c.push(e.assignTexture(a, "aoMap", s.occlusionTexture)), s.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = s.occlusionTexture.strength)), s.emissiveFactor !== void 0 && i !== H) {
      ...
      a.emissive = new C().setRGB(u[0], u[1], u[2], b);
    }
    return s.emissiveTexture !== void 0 && i !== H && c.push(e.assignTexture(a, "emissiveMap", s.emissiveTexture, G)), Promise.all(c).then(function() {
      const u = new i(a);
      return s.name && (u.name = s.name), N(u, s), e.associations.set(u, { materials: t }), s.extensions && O(n, u, s), u;
    });
  }
  createUniqueName(t) {
  ...
  loadGeometries(t) {
    ...
    for (let a = 0, o = t.length; a < o; a++) {
      const c = t[a], l = It(c), u = n[l];
      if (u)
        i.push(u.promise);
      else {
        let f;
        c.extensions && c.extensions[A.KHR_DRACO_MESH_COMPRESSION] ? f = s(c) : f = oe(new Oe(), c, e), n[l] = { primitive: c, promise: f }, i.push(f);
      }
    }
  ...
  loadMesh(t) {
    ...
    for (let o = 0, c = i.length; o < c; o++) {
      const l = i[o].material === void 0 ? wt(this.cache) : this.getDependency("material", i[o].material);
      a.push(l);
    }
    return a.push(e.loadGeometries(i)), Promise.all(a).then(function(o) {
      ...
      for (let h = 0, p = l.length; h < p; h++) {
        ...
        if (m.mode === _.TRIANGLES || m.mode === _.TRIANGLE_STRIP || m.mode === _.TRIANGLE_FAN || m.mode === void 0)
          g = s.isSkinnedMesh === !0 ? new Ce(T, E) : new Fe(T, E), g.isSkinnedMesh === !0 && g.normalizeSkinWeights(), m.mode === _.TRIANGLE_STRIP ? g.geometry = ne(g.geometry, Je) : m.mode === _.TRIANGLE_FAN && (g.geometry = ne(g.geometry, $e));
        ...
        Object.keys(g.geometry.morphAttributes).length > 0 && bt(g, s), g.name = e.createUniqueName(s.name || "mesh_" + t), N(g, s), m.extensions && O(n, g, m), e.assignFinalMaterial(g), u.push(g);
      }
      ...
      if (u.length === 1)
        return s.extensions && O(n, u[0], s), u[0];
      const f = new K();
      s.extensions && O(n, f, s), e.associations.set(f, { meshes: t });
      for (let h = 0, p = u.length; h < p; h++)
        f.add(u[h]);
      return f;
    });
  ...
  loadCamera(t) {
    ...
    return r.type === "perspective" ? e = new Ge(Be.radToDeg(n.yfov), n.aspectRatio || 1, n.znear || 1, n.zfar || 2e6) : r.type === "orthographic" && (e = new ve(-n.xmag, n.xmag, n.ymag, -n.ymag, n.znear, n.zfar)), r.name && (e.name = this.createUniqueName(r.name)), N(e, r), Promise.resolve(e);
  }
  loadSkin(t) {
  ...
  loadAnimation(t) {
    ...
    for (let u = 0, f = n.channels.length; u < f; u++) {
      const h = n.channels[u], p = n.samplers[h.sampler], T = h.target, m = T.node, g = n.parameters !== void 0 ? n.parameters[p.input] : p.input, E = n.parameters !== void 0 ? n.parameters[p.output] : p.output;
      T.node !== void 0 && (i.push(this.getDependency("node", m)), a.push(this.getDependency("accessor", g)), o.push(this.getDependency("accessor", E)), c.push(p), l.push(T));
    }
    return Promise.all([
      Promise.all(i),
      Promise.all(a),
      ...
      for (let E = 0, x = f.length; E < x; E++) {
        const R = f[E], S = h[E], y = p[E], L = T[E], P = m[E];
        if (R === void 0)
          continue;
        R.updateMatrix && R.updateMatrix();
        const M = r._createAnimationTracks(R, S, y, L, P);
        if (M)
  ...
  _loadNodeShallow(t) {
    ...
    return o && a.push(o), s.camera !== void 0 && a.push(n.getDependency("camera", s.camera).then(function(c) {
      ...
      let l;
      if (s.isBone === !0 ? l = new Ke() : c.length > 1 ? l = new K() : c.length === 1 ? l = c[0] : l = new le(), l !== c[0])
        for (let u = 0, f = c.length; u < f; u++)
          l.add(c[u]);
      if (s.name && (l.userData.name = s.name, l.name = i), N(l, s), s.extensions && O(r, l, s), s.matrix !== void 0) {
        const u = new B();
  ...
  loadScene(t) {
    const e = this.extensions, r = this.json.scenes[t], n = this, s = new K();
    r.name && (s.name = n.createUniqueName(r.name)), N(s, r), r.extensions && O(e, s, r);
    const i = r.nodes || [], a = [];
    for (let o = 0, c = i.length; o < c; o++)
    ...
    return Promise.all(a).then(function(o) {
      ...
      const c = (l) => {
        ...
        for (const [f, h] of n.associations)
          (f instanceof j || f instanceof J) && u.set(f, h);
        return l.traverse((f) => {
  ...
  _createAnimationTracks(t, e, r, n, s) {
    ...
    w[s.path] === w.weights ? t.traverse(function(f) {
    ...
    const l = n.interpolation !== void 0 ? Mt[n.interpolation] : pe, u = this._getArrayFromAccessor(r);
  ...
  _getArrayFromAccessor(t) {
    let e = t.array;
    if (t.normalized) {
      const r = Q(e.constructor), n = new Float32Array(e.length);
...
function oe(d, t, e) {
  ...
  return Z.workingColorSpace !== b && "COLOR_0" in r && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Z.workingColorSpace}" not supported.`), N(d, t), Dt(d, t, e), Promise.all(n).then(function() {
    return t.targets !== void 0 ? Nt(d, t.targets, e) : d;
  });
}
export {
  Ht as GLTFLoader
